...
Version: 1
Author: DrGeekthumb
Info: Uploads a file to your Discord server via a webhook. More info on webhooks can be found here: https://support.discord.com/hc/en-us/articles/228383668-Intro-to-Webhooks
